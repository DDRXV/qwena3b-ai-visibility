...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React47 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState13 = React47.useState, useEffect13 = React47.useEffect, useLayoutEffect2 = React47.useLayoutEffect, useDebugValue2 = React47.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React47 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef21 = React47.useRef, useEffect13 = React47.useEffect, useMemo19 = React47.useMemo, useDebugValue2 = React47.useDebugValue;
...
// node_modules/@base-ui/react/esm/dialog/description/DialogDescription.js
var DialogDescription = React5.forwardRef(function DialogDescription2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var FloatingDelayGroupContext = React7.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
var FocusGuard = React8.forwardRef(function FocusGuard2(props, ref) {
...
var PortalContext = React9.createContext(null);
...
var FloatingPortal = React9.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  const focusInsideDisabledRef = React9.useRef(false);
  ...
  return (0, import_jsx_runtime3.jsxs)(React9.Fragment, {
...
var useFloatingParentNodeId = () => {
  var _a;
  return ((_a = React10.useContext(FloatingNodeContext)) == null ? void 0 : _a.id) || null;
};
var useFloatingTree = (externalTree) => {
  const contextTree = React10.useContext(FloatingTreeContext);
...
function FloatingFocusManager(props) {
  ...
  const orderRef = React11.useRef(["content"]);
  const initialFocusRef = useValueAsRef(initialFocus);
  const returnFocusRef = useValueAsRef(returnFocus);
  const openInteractionTypeRef = useValueAsRef(openInteractionType);
  const tree = useFloatingTree(externalTree);
  const portalContext = usePortalContext();
  const preventReturnFocusRef = React11.useRef(false);
  const isPointerDownRef = React11.useRef(false);
  const pointerDownOutsideRef = React11.useRef(false);
  const lastFocusedTabbableRef = React11.useRef(null);
  const closeTypeRef = React11.useRef("");
  const lastInteractionTypeRef = React11.useRef("");
  const beforeGuardRef = React11.useRef(null);
  const afterGuardRef = React11.useRef(null);
  ...
  return (0, import_jsx_runtime5.jsxs)(React11.Fragment, {
...
function useClick(context, props = {}) {
  ...
  const pointerTypeRef = React12.useRef(void 0);
...
function useRole(context, props = {}) {
  ...
  const item = React31.useCallback(({
    active,
    selected
  }) => {
    const commonProps = {
...
var DialogPortalContext = React33.createContext(void 0);
...
var DialogPopup = React34.forwardRef(function DialogPopup2(componentProps, forwardedRef) {
  const {
    className,
    finalFocus,
    initialFocus,
...
var InternalBackdrop = React35.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
var DialogPortal = React36.forwardRef(function DialogPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
var DialogStore = class _DialogStore extends ReactStore {
  constructor(initialState) {
    super(createInitialState(initialState), {
      popupRef: React42.createRef(),
      backdropRef: React42.createRef(),
      internalBackdropRef: React42.createRef(),
...
var IsDrawerContext = React43.createContext(false);
...
var DialogViewport = React44.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    className,
    render,
    children,
...
var DialogTitle = React45.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogTrigger = React46.forwardRef(function DialogTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled: disabled2 = false,
